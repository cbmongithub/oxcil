...
export function Footer() {
  return (
    <Section as="footer" divider spacing="section">
      <PageContainer>
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mt-4 max-w-xs text-sm">
              AI lead infrastructure for local service businesses, starting with focused
              landing pages, lead intake, routing, and a manual-first operating loop.
            </p>
          </div>
