...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "text-foreground/50 hover:text-foreground group-[.destructive]:text-primary-foreground/80 group-[.destructive]:hover:text-primary-foreground group-[.destructive]:focus:ring-primary/30 group-[.destructive]:focus:ring-offset-primary/60 absolute top-2 right-2 rounded-md p-1 opacity-0 transition-opacity group-hover:opacity-100 focus:opacity-100 focus:ring-2 focus:outline-none",
      className
    )}
    toast-close=""
    {...props}
