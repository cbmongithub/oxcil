      ...
      {meteorStyles.map((style, idx) => (
        <span
          ...
          className={cn(
            ...
            "before:absolute before:bottom-full before:left-1/2 before:h-[120px] before:w-[1px] before:-translate-x-1/2 before:bg-gradient-to-t before:from-white/80 before:via-blue-400/30 before:to-transparent before:content-['']"
          )}
          style={{
            top: style.top,
            left: style.left,
