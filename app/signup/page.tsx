      ...
      <div className="relative z-10 hidden flex-col justify-between p-12 lg:flex lg:w-1/2">
        ...
        <div className="max-w-md">
          ...
          <div className="mt-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-foreground font-medium">James Chen</p>
              <p className="text-muted-foreground text-sm">CTO, Quantum Labs</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-card/50 rounded-xl border border-white/5 p-8 backdrop-blur-sm">
            <div className="mb-8 text-center">
              ...
              <p className="text-muted-foreground mt-2 text-sm">
                Start building with 50+ AI models in minutes
              </p>
            </div>
