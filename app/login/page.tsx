      ...
      <div className="relative z-10 hidden flex-col justify-between p-12 lg:flex lg:w-1/2">
        ...
        <div className="max-w-md">
          <blockquote className="text-foreground text-2xl leading-relaxed font-medium">
            &ldquo;The unified API made switching between models seamless. We went from
            prototype to production in days, not weeks.&rdquo;
          </blockquote>
          <div className="mt-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-foreground font-medium">Sarah Rodriguez</p>
              <p className="text-muted-foreground text-sm">Lead Engineer, NexaAI</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-12">
          <div>
            <p className="text-foreground text-3xl font-semibold">50+</p>
            <p className="text-muted-foreground mt-1 text-sm">AI Models</p>
          </div>
          <div>
          ...
          <div>
            <p className="text-foreground text-3xl font-semibold">12ms</p>
            <p className="text-muted-foreground mt-1 text-sm">Avg Latency</p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-card/50 rounded-xl border border-white/5 p-8 backdrop-blur-sm">
            <div className="mb-8 text-center">
              ...
              <p className="text-muted-foreground mt-2 text-sm">
                Sign in to your Oxcil account
              </p>
            </div>

            {/* Social sign in */}
            <div className="mb-6 flex gap-3">
              <button className="text-foreground flex flex-1 items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm transition-colors hover:bg-white/10">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="text-foreground placeholder:text-muted-foreground focus:ring-primary/50 focus:border-primary w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 pr-11 transition-all focus:ring-2 focus:outline-none"
                  />
                  <button
                    type="button"
