...
**Protection:** To protect the rights, property, and safety of Oxcil, our users, or others.
...
To exercise these rights, contact us at privacy@oxcil.ai.`,
  },
  {
...
If you believe we have collected information from a child, please contact us immediately at privacy@oxcil.ai, and we will take steps to delete such information.`,
  },
  {
...
**Privacy Inquiries:** privacy@oxcil.ai

**Data Protection Officer:** dpo@oxcil.ai
          ...
          <div className="mx-auto max-w-3xl">
            <div className="bg-card/50 border-border/50 rounded-xl border p-8 backdrop-blur-sm md:p-12">
              <p className="text-muted-foreground mb-8 leading-relaxed">
                At Oxcil, we take your privacy seriously. This Privacy Policy explains how
              ...
              <div className="space-y-8">
                {sections.map((section, index) => (
                  ...
                  >
                    ...
                    <div className="text-muted-foreground prose-strong:text-foreground prose-strong:font-medium leading-relaxed whitespace-pre-line">
              ...
              <div className="border-border/50 mt-12 border-t pt-8">
                <p className="text-muted-foreground text-sm">
                  By using Oxcil, you acknowledge that you have read and understood this
                  Privacy Policy. See also our{" "}
