...
const sections = [
  {
    ...
    content: `By accessing or using Oxcil's services, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing our services.
...
These terms apply to all users, including visitors, registered users, and API consumers. We reserve the right to modify these terms at any time, and your continued use of the service constitutes acceptance of those modifications.`,
  },
  {
    ...
    content: `Oxcil provides AI inference infrastructure and API services that enable developers and organizations to access and deploy machine learning models. Our services include:
...
We reserve the right to suspend or terminate accounts that violate these terms or engage in fraudulent activity.`,
  },
  {
    ...
    content: `Your use of Oxcil APIs is subject to rate limits and usage quotas as specified in your plan. You agree to:
...
You are responsible for all taxes associated with your use of our services, excluding taxes based on our net income.`,
  },
  {
    ...
    content: `Oxcil retains all rights, title, and interest in our services, including all intellectual property rights. You retain ownership of:
...
Violation of these restrictions may result in immediate termination without refund.`,
  },
  {
    ...
    content: `TO THE MAXIMUM EXTENT PERMITTED BY LAW, Oxcil SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR GOODWILL.
...
Our total liability for any claims arising from these terms or your use of our services shall not exceed the amount you paid us in the twelve months preceding the claim.`,
  },
  {
    ...
    content: `You agree to indemnify, defend, and hold harmless Oxcil and its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from:
...
Email: legal@oxcil.ai
Address: 123 AI Boulevard, Suite 400, San Francisco, CA 94105

For general support inquiries, please visit our documentation or contact support@oxcil.ai.`,
  },
];
      ...
      <div className="relative pb-24">
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-3xl">
            <div className="bg-card/50 border-border/50 rounded-xl border p-8 backdrop-blur-sm md:p-12">
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Welcome to Oxcil. These Terms of Service ("Terms") govern your access to
                and use of Oxcil's products, services, and APIs. Please read these terms
              ...
              <div className="space-y-8">
                {sections.map((section, index) => (
                  <section
                    key={index}
                    className="border-border/50 border-b pb-8 last:border-0 last:pb-0"
                  >
              ...
              <div className="border-border/50 mt-12 border-t pt-8">
                <p className="text-muted-foreground text-sm">
                  By using Oxcil, you acknowledge that you have read, understood, and
